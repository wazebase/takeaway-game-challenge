...
export const chatService = () => {
    ...
    const setCurrentNumberAndSendMessage = (response: IRandomNumberResponse, messageStyle: string): void => {
    ...
    const getMessageStyle = (response: IRandomNumberResponse): [string, string] => {
    ...
    const addMessageToStore = (response: IMessageResponse): void => {
        let message;
